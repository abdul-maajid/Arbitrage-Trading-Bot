...
const abi = require('./ABIConstants.js');
...
const wethContract = constructContract(Tokens.WETH.address, abi.IERC20, privateKey);
const daiContract = constructContract(Tokens.DAI.address, abi.IERC20, privateKey);
const mkrContract = constructContract(Tokens.MKR.address, abi.IERC20, privateKey);
const batContract = constructContract(Tokens.BAT.address, abi.IERC20, privateKey);
